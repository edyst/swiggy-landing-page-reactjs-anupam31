    ...
    return(
        ...
        <div className="container">
          <div className="row">
            ...
            <h2 class="reshead1">Restaurants in </h2>
            <h2 class="reshead2">your pocket</h2>
            <div class="div1">Order from your favorite restaurants & track on the go, with the all-new Swiggy app.</div>
