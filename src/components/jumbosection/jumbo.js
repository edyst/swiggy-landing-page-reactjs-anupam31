...
const Jumbo =()=>
{
    return(
        ...
        <section className="flipper">
          <div className="flipper_div1" id="int">
            ...
            <div className="contain width">
              ...
              <p id="flipper_heading">Order food from favourite restaurants near you.</p>
            </div>
            <div className="input-container width">
              ...
              <button type="submit" className="findfood">
                FIND FOOD
              </button>
            </div>
